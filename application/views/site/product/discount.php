                    ...
                    foreach ($product_list as $value) {
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 re-padding">
                            <div class="product_item">
                                ...
                                if ($sl > 0) {
                                    ?>
                                    <a href="<?php echo base_url('cart/add/' . $value->id); ?>" class='btn btn-info'><span class="fa fa-shopping-cart" aria-hidden="true"></span> Thêm giỏ hàng</a>
                                <?php } else { ?>
                                    <a style="pointer-events: none;background-color: #333;" class='btn btn-info'>Hết hàng</a>
                                <?php } ?>
                            </div>
                        </div>
                    <?php } ?>	
