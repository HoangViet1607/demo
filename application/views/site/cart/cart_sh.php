      ...
      <div class="table-responsive" style="min-width: 400px;">
         <table class="table table-hover">
          ...
          <a href="<?php echo base_url('cart'); ?>" type="button" class="btn btn-success" style="margin-left: 10px"> Chi Tiết Giỏ Hàng </a>
           <a href="<?php echo base_url('cart/del'); ?>" type="button" class="btn btn-danger pull-right" style="margin-right: 10px;background-color: #4A73B5"> Xóa </a>
      </div>
    <?php }else{ ?>
        <p style="color:#2F4858;font-weight: bold;float: right;padding-right: 30px">Không có sản phẩm trong giỏ hàng</p>
    <?php  } ?>
  </ul>
</li>