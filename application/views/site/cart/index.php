                        ...
                        <tbody>
                            ...
                            foreach ($carts as $items) {
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 150px;padding-left: 20px">
                                    ...
                                    <td><a style="color: black" href="<?php echo base_url('cart/del/' . $items['cartid']); ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
